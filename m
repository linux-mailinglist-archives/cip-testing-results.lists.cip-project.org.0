...
Received: from whitealder.osuosl.org (smtp1.osuosl.org [140.211.166.138])
	by mail.lfdr.de (Postfix) with ESMTPS id 0806F1921CC
	for <lists@lfdr.de>; Wed, 25 Mar 2020 08:38:12 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by whitealder.osuosl.org (Postfix) with ESMTP id 8566486DFC;
	Wed, 25 Mar 2020 07:38:10 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from whitealder.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id pc3npt4GC5Xd; Wed, 25 Mar 2020 07:38:07 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by whitealder.osuosl.org (Postfix) with ESMTP id 707768805E;
	Wed, 25 Mar 2020 07:38:07 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id 590E6C1D88;
	Wed, 25 Mar 2020 07:38:07 +0000 (UTC)
X-Original-To: cip-testing-results@lists.cip-project.org
Delivered-To: cip-testing-results@lists.linuxfoundation.org
Received: from silver.osuosl.org (smtp3.osuosl.org [140.211.166.136])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 5BBA6C0177
 for <cip-testing-results@lists.cip-project.org>;
 Wed, 25 Mar 2020 07:38:05 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by silver.osuosl.org (Postfix) with ESMTP id 38A1D23A53
 for <cip-testing-results@lists.cip-project.org>;
 Wed, 25 Mar 2020 07:38:05 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from silver.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id XLwIkmlGp2ex
 for <cip-testing-results@lists.cip-project.org>;
 Wed, 25 Mar 2020 07:38:01 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from a27-52.smtp-out.us-west-2.amazonses.com
 (a27-52.smtp-out.us-west-2.amazonses.com [54.240.27.52])
 by silver.osuosl.org (Postfix) with ESMTPS id 59AE0203CE
 for <cip-testing-results@lists.cip-project.org>;
 Wed, 25 Mar 2020 07:38:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/simple;
 s=sef3ipnhs6zyfoh33edxhxokcqriataq; d=ciplatform.org; t=1585121880;
 h=MIME-Version:Content-Type:Content-Transfer-Encoding:Subject:From:To:Date:Message-ID;
 bh=DIvcrHZLEinTppsFowIcFy1wELf9z9mcxV4LXEeOL5A=;
 b=SyDxAt1G7tQk8c8CHm6lU/DqbWdyau78a6O47OPEP4S3Xl+zV46vqEAuNxhfqHre
 9ddyAFdEpttEpBM5f4Q9kXR1CYsiIUuvRKuIO7Thma6MUIsLIN4XZvFUrVRBZlmFIG5
 U8wFH/xqKzHIzyowXWbv/ehcXhOSCiE46x3ncKsY=
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/simple;
 s=hsbnp7p3ensaochzwyq5wwmceodymuwv; d=amazonses.com; t=1585121880;
 h=MIME-Version:Content-Type:Content-Transfer-Encoding:Subject:From:To:Date:Message-ID:Feedback-ID;
 bh=DIvcrHZLEinTppsFowIcFy1wELf9z9mcxV4LXEeOL5A=;
 b=k8jAOSG1CmsepLISwRrCnh6BqcC+40vPwhL6rO5vxBGgf4FLWDunTpF8u0UfOLHz
 3aZ8FDXfw2oNgwQa1Z5guMFlcG4gfNo41gL7g9AJRogA8fEFf96xhyemS+m1upGq8Fu
 TgUSSEI0z6me0fbknPjYoyo7U6IeQdz0VMPVe21s=
MIME-Version: 1.0
From: noreply@ciplatform.org
To: cip-testing-results@lists.cip-project.org
Date: Wed, 25 Mar 2020 07:38:00 +0000
Message-ID: <0101017110a0698e-81e0b603-c1dd-4bce-aa0f-7f1f5f987e4d-000000@us-west-2.amazonses.com>
X-SES-Outgoing: 2020.03.25-54.240.27.52
Feedback-ID: 1.us-west-2.dpZ3+4zb8Tw1/c7xkFZPskvGKx/SAg98+h1xxHxUxV4=:AmazonSES
Subject: [Cip-testing-results] LAVA notification for Test Job 13371
 ci-iwamatsu-linux-4.4.y-cip-rc_bzImage_cip_qemu_defconfig_4.4.217-cip43_486102b1_x86_cip_qemu_defconfig_ltp-syscalls-tests
...
The job with ID # 13371 is now in state Finished and health Complete. Job was submitted by CIP-Testing.

Job details and log file: http://lava.ciplatform.org/scheduler/job/13371
...
Description: ci-iwamatsu-linux-4.4.y-cip-rc_bzImage_cip_qemu_defconfig_4.4.217-cip43_486102b1_x86_cip_qemu_defconfig_ltp-syscalls-tests
Submitted: 2020-03-25 06:28:36 (+0000 UTC)
Started: 2020-03-25 06:59:22 (+0000 UTC)
Finished: 2020-03-25 07:38:00 (+0000 UTC)
Duration: 0:38:38.243050
...
Test Suite 1_ltp-syscalls-tests: http://lava.ciplatform.org/results/13371/1_ltp-syscalls-tests
...
Test Case copy_file_range01: Test skipped
...
Test Case vmsplice02: Test passed
Test Case vmsplice01: Test passed
...
Test Case utime02: Test passed
Test Case utime01A: Test passed
Test Case utime01: Test passed
...
Test Case renameat202: Test passed
Test Case renameat201: Test passed
...
Test Case quotactl01: Test passed
...
Test Case llistxattr03: Test passed
Test Case llistxattr02: Test passed
Test Case llistxattr01: Test passed
Test Case listxattr03: Test passed
Test Case listxattr02: Test passed
Test Case listxattr01: Test passed
...
Test Case lgetxattr02: Test passed
Test Case lgetxattr01: Test passed
...
Test Case signal06: Test passed
...
Test Case fanotify10: Test skipped
...
Test Case getrusage04: Test skipped
...
Test Case getrandom02: Test failed
...
Test Case fallocate03: Test passed
Test Case fallocate02: Test passed
Test Case fallocate01: Test passed
...
Test Case modify_ldt03: Test skipped
Test Case modify_ldt02: Test skipped
Test Case modify_ldt01: Test skipped
...
Test Case flistxattr03: Test passed
Test Case flistxattr02: Test passed
Test Case flistxattr01: Test passed
...
Test Case fcntl23_64: Test passed
Test Case fcntl23: Test passed
...
Test Case fcntl16_64: Test passed
Test Case fcntl16: Test passed
...
Test Suite lava: http://lava.ciplatform.org/results/13371/lava
Test Case job: Test passed
Test Case read-feedback: Test failed
Measurement: 6.6100000000 seconds
Test Case 1_ltp-syscalls-tests: Test passed
Measurement: 2238.8900000000 seconds
