Return-Path: <bounce+64575+234581+4520527+8129362@lists.cip-project.org>
X-Original-To: lists@lfdr.de
Delivered-To: lists@lfdr.de
Received: from mail01.groups.io (web01.groups.io [66.175.222.12])
	by mail.lfdr.de (Postfix) with ESMTPS id BBBD27D9330
	for <lists@lfdr.de>; Fri, 27 Oct 2023 11:11:09 +0200 (CEST)
DKIM-Signature: a=rsa-sha256; bh=Ujte9JWUhPykgHVGN/2IL3a03Ns0B5A7HoN7M/xD0D4=;
 c=relaxed/simple; d=lists.cip-project.org;
 h=MIME-Version:Subject:From:To:Date:Message-ID:Feedback-ID:Precedence:List-Subscribe:List-Help:Sender:List-Id:Mailing-List:Delivered-To:Reply-To:List-Unsubscribe-Post:List-Unsubscribe:Content-Type:Content-Transfer-Encoding;
 s=20140610; t=1698397868; v=1;
 b=Sxwpd5MPyIYsvQAKLjiYvvvjYtMDrOBid8INyJ2A0dky9+DYfjEHswcbaeOVJfbkFQbFHbDv
 WgG9ue0qRf1CZaAUUuO0gMqQVgKKqwdK11nEwwYgbwGO/y2LlQHIOeUpOiIEr/WyDB10lecXhyT
 88PFHZLwtmG7a4T3/y+Xanio=
X-Received: by 127.0.0.2 with SMTP id wHD3YY4521862xwTAYARb8NW; Fri, 27 Oct 2023 02:11:08 -0700
X-Received: from a27-27.smtp-out.us-west-2.amazonses.com (a27-27.smtp-out.us-west-2.amazonses.com [54.240.27.27])
 by mx.groups.io with SMTP id smtpd.web11.2980.1698397867930630686
 for <cip-testing-results@lists.cip-project.org>;
 Fri, 27 Oct 2023 02:11:08 -0700
MIME-Version: 1.0
Subject: [cip-testing-results] LAVA notification for Test Job 1027583 v4.4.302-cip79_cip_qemu_defconfig_4.4.302-cip79_bc5d9112_x86_cip_qemu_defconfig_ltp-syscalls-tests
From: noreply@ciplatform.org
To: cip-testing-results@lists.cip-project.org
Date: Fri, 27 Oct 2023 09:11:06 +0000
Message-ID: <0101018b7066cbd7-c4d8fad5-d258-4b17-b0db-99857a714e3d-000000@us-west-2.amazonses.com>
...
X-Gm-Message-State: N4RyXLLM2MazsReLcSO3FXKHx4520527AA=
...
The job with ID # 1027583 is now in state Finished and health Complete. Job=
 was submitted by buurenvans.

Job details and log file: http://lava.ciplatform.org/scheduler/job/1027583
...
Started: 2023-10-27 08:30:24 (+0000 UTC)
...
Test Suite lava: http://lava.ciplatform.org/results/1027583/lava
...
Measurement: 2187.75 seconds
Test Case read-feedback: Test failed
Measurement: 3.87 seconds
Test Case job: Test passed

Test Suite 1_ltp-syscalls-tests: http://lava.ciplatform.org/results/1027583=
...
View/Reply Online (#234581): https://lists.cip-project.org/g/cip-testing-re=
sults/message/234581
Mute This Topic: https://lists.cip-project.org/mt/102217465/4520527
