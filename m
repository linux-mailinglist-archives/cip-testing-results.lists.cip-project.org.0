...
Received: from silver.osuosl.org (smtp3.osuosl.org [140.211.166.136])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C56F132CA2
	for <lists@lfdr.de>; Tue,  7 Jan 2020 18:10:21 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by silver.osuosl.org (Postfix) with ESMTP id 1527A203D5;
	Tue,  7 Jan 2020 17:10:20 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from silver.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id SAEgfs64hVTX; Tue,  7 Jan 2020 17:10:15 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by silver.osuosl.org (Postfix) with ESMTP id 099CB20408;
	Tue,  7 Jan 2020 17:10:14 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id E34E3C1D85;
	Tue,  7 Jan 2020 17:10:14 +0000 (UTC)
X-Original-To: cip-testing-results@lists.cip-project.org
Delivered-To: cip-testing-results@lists.linuxfoundation.org
Received: from whitealder.osuosl.org (smtp1.osuosl.org [140.211.166.138])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 263E7C0881
 for <cip-testing-results@lists.cip-project.org>;
 Tue,  7 Jan 2020 17:10:13 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by whitealder.osuosl.org (Postfix) with ESMTP id 2206C8568D
 for <cip-testing-results@lists.cip-project.org>;
 Tue,  7 Jan 2020 17:10:13 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from whitealder.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id 8RK+Jz6OsvQj
 for <cip-testing-results@lists.cip-project.org>;
 Tue,  7 Jan 2020 17:10:10 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from a27-24.smtp-out.us-west-2.amazonses.com
 (a27-24.smtp-out.us-west-2.amazonses.com [54.240.27.24])
 by whitealder.osuosl.org (Postfix) with ESMTPS id E172A811EF
 for <cip-testing-results@lists.cip-project.org>;
 Tue,  7 Jan 2020 17:10:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/simple;
 s=sef3ipnhs6zyfoh33edxhxokcqriataq; d=ciplatform.org; t=1578417009;
 h=MIME-Version:Content-Type:Content-Transfer-Encoding:Subject:From:To:Date:Message-ID;
 bh=Kyll+y8Xk3rpWjh0Cl8IoGOZBgRo1u3GAl934EAYYJg=;
 b=ilzD/woijHxguLxyMxDTCdmSggznFAVG7Se8MC/3Iz4+wF9klksmJJzlyQKgasER
 4NuK9yICzcy5vMgmha54bDfeoRjZT/AbIHCEB9xIaoAaVSbOYNzKgs81FHRIssBcgRM
 t14ggqrQYrJq+GLDpwX0U6fnPbd813+c2KmHhwgA=
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/simple;
 s=gdwg2y3kokkkj5a55z2ilkup5wp5hhxx; d=amazonses.com; t=1578417009;
 h=MIME-Version:Content-Type:Content-Transfer-Encoding:Subject:From:To:Date:Message-ID:Feedback-ID;
 bh=Kyll+y8Xk3rpWjh0Cl8IoGOZBgRo1u3GAl934EAYYJg=;
 b=e8JF48uHrskK6FMD3EVIdS2A1ekXT1H3QHPpLqL8MQKwXaVJMO8mQ9zVx6TySGQj
 8jkQ2NVnL/6dLtWr4eq9jSOAG67DxC9sz9/XS9GYIvWP5jOSLUC1RLWeX3PclUugxGM
 7BJgw9D6YYx0OsbzFpqjatmNAlEfHPWjcVsqFE2c=
MIME-Version: 1.0
From: noreply@ciplatform.org
To: cip-testing-results@lists.cip-project.org
Date: Tue, 7 Jan 2020 17:10:09 +0000
Message-ID: <0101016f80fc3145-24a00b44-64d8-41a8-b9a3-fee53a51a083-000000@us-west-2.amazonses.com>
X-SES-Outgoing: 2020.01.07-54.240.27.24
Feedback-ID: 1.us-west-2.dpZ3+4zb8Tw1/c7xkFZPskvGKx/SAg98+h1xxHxUxV4=:AmazonSES
Subject: [Cip-testing-results] LAVA notification for Test Job 9250
...
The job with ID # 9250 is now in state Finished and health Complete. Job was submitted by CIP-Testing.

Job details and log file: http://lava.ciplatform.org/scheduler/job/9250
...
Submitted: 2020-01-07 14:58:59 (+0000 UTC)
Started: 2020-01-07 15:12:23 (+0000 UTC)
Finished: 2020-01-07 17:10:08 (+0000 UTC)
Duration: 1:57:44.823543
...
Test Suite 1_ltp-syscalls-tests: http://lava.ciplatform.org/results/9250/1_ltp-syscalls-tests
...
Test Suite lava: http://lava.ciplatform.org/results/9250/lava
Test Case job: Test passed
Test Case power-off: Test passed
Measurement: 0.2300000000 seconds
Test Case 1_ltp-syscalls-tests: Test passed
Measurement: 6874.0700000000 seconds
